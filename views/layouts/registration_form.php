<div class="login-form relative flex-center p-5">
  ...
  <form action="" method="post" class="w-100 ">
    ...
    <div class="form-control flex-col w-100 pb-5">
      ...
      <input type="text" name="name" class="form-input" value="<?php echo @$_POST['name']; ?>" placeholder="Mario" />
    </div>

    <!-- last name -->
    <div class="form-control flex-col w-100 pb-5">
      <label class="form-label pb-3" for="lastname">Inserisci il tuo cognome</label>
      <input type="text" name="lastname" class="form-input" value="<?php echo @$_POST['lastname']; ?>"
        placeholder="Rossi" />
    </div>
    ...
    <div class="form-control flex-col w-100 pb-5">
      ...
      <input type="password" name="password" class="form-input" value="<?php echo @$_POST['password']; ?>"
